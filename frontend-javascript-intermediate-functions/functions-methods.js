...
function checkEmailValidity2(str) {
    const positionFirst = str.indexOf("@");
    const positionLast = str.lastIndexOf("@");
    if (!str.includes("@"))  {
        return "Geen geldig email adres er komt geen @ in voor.";
    }else if (positionFirst !== positionLast) {
        return "Geen geldig email adres @ komt meerder keren voor.";
    }else if (str.includes(",")) {
        return "Geen geldig email adres er komt een , in voor.";
    } else if (str.charAt(str.length - 1) === ".") {
        return "Geen geldig email adres laatste character is een .";
    }
    return "Geldig email adres.";
}

result = checkEmailValidity2("n.eeken@novi.nl");
console.log(result);
result = checkEmailValidity2("tessmellink@novi.nl");
console.log(result);
result = checkEmailValidity2("n.eekenanovi.nl");
console.log(result);
result = checkEmailValidity2("n.eeken@novinl.");
console.log(result);
result = checkEmailValidity2("tessmellink@novi,nl");
console.log(result);

...
function merge(firstString,seccondString){
  return firstString+seccondString;
}
let firstString = "abra";
let seccondString = "cadabra";
result = merge(firstString,seccondString);
console.log(result);
firstString = "zoet";
seccondString = "sappig";
result = merge(firstString,seccondString);
console.log(result);
/* Opdracht  4 */
